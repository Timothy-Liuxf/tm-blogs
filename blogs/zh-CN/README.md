...
+ [计算机程序设计基础（1）](./lessons/programming_1/lecture.md)
+ [计算机程序设计基础（2）](./lessons/programming_2/lecture.md)
+ [数据与算法](./lessons/data_and_algorithm/lecture.md)
+ [数字逻辑与处理器基础](./lessons/digital_logic_and_cpu/lecture.md)
